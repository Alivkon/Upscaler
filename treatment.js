...
// читает браузер приёмки (`public/treat-local.js`). Тот, кто поставил галочку,
// просит не «сделайте потемнее», а «сделайте как у вас», и разойтись эти два
// ответа не должны: два набора настроек означали бы, что витрина и приёмка со
// временем разъедутся молча.
//
