...
//   3. приглушение ×0.80;
//   4. потолок средней цветности ≤18, а у `CEIL` ещё и средней яркости ≤65.
//
...
// приглушение ×0.80 достаётся и светлой работе, и тёмной. Это и есть разница
// между двумя правилами — `CEIL` темнит светлое сильнее.
export const DIM = { t: 0.55, dim: COLLECTION_DIM, capC: 18 };
export const CEIL = { ...DIM, capL: 65 };
