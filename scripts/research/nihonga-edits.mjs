...
//
// СТАРЫЙ ЛИСТ: двенадцать версий на работу — шесть правок и у каждой двойник
// с углами. С 12.09.2026 ни правок, ни виньеток в генераторе нет: у обработки
// три значения (скан, `dim`, `ceil`). Файл сохранён как есть, потому что по
// нему отбирали 24.08; клонировать для нового листа — `treat-sheet.mjs`.
//
