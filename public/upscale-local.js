...
import { GATE_LONG, GATE_SHORT, MAX_SIDE, phoneWindow, targetLongestSideFor } from './frame.js';
...
// Потолок стороны — общий с сервером и живёт в frame.js: у Canvas есть предел
// стороны, а память кончается раньше предела. Здесь к нему добавляется второй,
// на площадь, и опаснее он. У Safari холст ограничен
