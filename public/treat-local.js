// Галочки «сделайте как у вас» и «кадр под телефон», посчитанные в браузере.
//
...
// временем разъедутся молча, а разойтись эти два ответа не должны: человек
// ставит галочку, прося «как у вас».
//
